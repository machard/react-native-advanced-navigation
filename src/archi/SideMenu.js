// copy of react native side menu. 
// because we need real onChangeEnd event !
...
class SideMenu extends Component {
  ...
  openMenu() {
    ...
    var anim = this.anim = (this.anim || 0) + 1;
    requestAnimationFrame(() =>
      this.props
        .animationFunction(left, openOffset)
        .start(() => {
          if (anim === this.anim)
            this.props.onChangeEnd(isOpen);
        })
    );
  ...
  closeMenu() {
    ...
    requestAnimationFrame(() =>
      this.props
        .animationFunction(left, closeOffset)
        .start(() => {
          if (this.anim === anim)
            this.props.onChangeEnd(isOpen);
        })
  ...
  getContentView() {
    ...
    if (this.state.isOpen && this.props.touchToClose) {
      overlay = (
